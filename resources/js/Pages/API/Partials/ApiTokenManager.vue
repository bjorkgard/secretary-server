          ...
          <div class="mt-2 grid grid-cols-1 md:grid-cols-2 gap-4">
            <div v-for="permission in availablePermissions" :key="permission">
              <label class="flex items-center">
                <input v-model="createApiTokenForm.permissions" type="checkbox" :value="permission" class="checkbox checkbox-secondary">
    ...
    <DialogModal :show="managingPermissionsFor != null" @close="managingPermissionsFor = null">
      ...
      <template #content>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div v-for="permission in availablePermissions" :key="permission">
            <label class="flex items-center">
              <input v-model="updateApiTokenForm.permissions" type="checkbox" class="checkbox checkbox-secondary" :value="permission">
