...
<template>
    <DialogModal :show="show" @close="closeModal">
        ...
        <template #footer>
            <button class="btn btn-accent" @click="closeModal">{{__('common.cancel')}}</button>
            <button class="ms-3 btn btn-primary" :class="{ 'opacity-25': form.processing }" :disabled="form.processing || !form.attend" @click="saveReport">{{__('common.save')}}</button>
        </template>
    </DialogModal>
</template>
